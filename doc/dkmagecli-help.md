...
USAGE: 
   ...
   dkmagecli  [-h] [--stop_on_fail] [--test_addons] [--test_mode]
              [--version] [--output_auto|--output_id <int>|--output_path
              <path string>|--output_subpath <path string>] [--config <path
              string>] [--output_bmp <path string>] [--seed <any string>]
