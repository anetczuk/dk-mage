...
Archive contains numerous unit tests and simple example how to use the bindings under Python. Unit tests can be executed from bindings root directory by following command: `python3 -m unittest`.
