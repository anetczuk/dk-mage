...
//        level->optns.picture.rescale = 2;
    ...
    void Level::setInfo() {
        ...
        static const char* DEF_LVL_NAME = "dk-mage map";
        char* str_array = (char*) malloc( strlen(DEF_LVL_NAME)*sizeof(char) );          /// will be freed by libadikted internals
        strcpy( str_array, DEF_LVL_NAME );
