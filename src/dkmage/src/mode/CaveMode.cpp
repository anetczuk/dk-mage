...
//                script.setMagicAvailable( adiktedpp::PlayerType::PT_ALL, adiktedpp::AvailableMode::AM_ENABLED );
 ...
 //                LOG() << "dungeon:\n" << dungeon.print();
                 ...
                 /// add gold vein
                 const Point leftVeinCenter( bbox.min.x - 20, firstCenter.y - 1 );
                 const Rect leftVeinRect( leftVeinCenter, 9, 5 );
                 drawGoldVein( level, leftVeinRect, 1 );

                 const Point rightVeinCenter( bbox.max.x + 28, firstCenter.y - 1 );
...
//                enemyDungeon.generate( 6, 5 );
            ...
            //    LOG() << "enemy dungeon:\n" << enemyDungeon.print();
...

                {
                    ...
                    level.digLine( firstCenter, veinCenter, owner, false );
